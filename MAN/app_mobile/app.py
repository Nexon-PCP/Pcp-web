...
def apresentacao():
    ...
    # ===== OPS =====
    todas_ops = OP.query.join(Obra).order_by(Obra.corte_dobra_inicio.asc()).all()
    ops_list = []
    for op in todas_ops:
...
def api_op_detalhes(op_id):
    """API que retorna detalhes de uma OP específica"""
    try:
        ...
        for etapa in op.etapas:
            ...
            etapas_list.append({
                ...
                "horas_previstas": etapa.horas_previstas or 0,
