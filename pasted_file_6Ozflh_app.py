...
def apresentacao():
    ...
    em_prod = OP.query.filter_by(status="EM_PRODUCAO").count()
    ...
    # ===== OBRAS =====
    todas_obras = Obra.query.order_by(Obra.corte_dobra_inicio.asc()).limit(20).all()
    obras_list = []
    ...
    # ===== OPS =====
    todas_ops = OP.query.join(Obra).order_by(Obra.corte_dobra_inicio.asc()).limit(20).all()
    ops_list = []
    for op in todas_ops:
